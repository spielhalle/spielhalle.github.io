(function () {
  ...
  (function () {
    ...
    var __webpack_modules__ = {
      ...
      9126: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        ...
        addEventListener('message', function (evt) {
          ...
          var results = 0;
          var lastResult = 0;
          (0, _donmahallem_sudoku__WEBPACK_IMPORTED_MODULE_0__.knuthSolve)(new Array(size).fill(0).map(function () {
            return new Array(size).fill(0);
          }), size, Math.sqrt(size), function (board) {
            results += 1;
            var tDelta = Date.now() - startTime;
    ...
    __webpack_require__.x = function () {
      ...
      /******/
      var __webpack_exports__ = __webpack_require__.O(undefined, ["default-node_modules_donmahallem_sudoku_dist_esm_index_js", "common"], function () {
        return __webpack_require__(9126);
      });
      /******/
...
//# sourceMappingURL=benchmarkSudokuWorker-es5.js.map